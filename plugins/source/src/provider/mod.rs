//! Source-code provider — tree-sitter parsing, symbol resolution, and content access.
//!
//! Registers the FUSE [`Provider`](nyne::router::Provider) that contributes virtual
//! nodes to the nyne VFS, owning the route tree that maps companion-namespace paths
//! (`file.rs@/symbols/...`) to virtual nodes and dispatching to the resolve, lookup,
